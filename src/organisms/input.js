...
export class _InputElement extends LitElement {
  ...
  __onFormActivate (currentTarget) { // eslint-disable-line class-methods-use-this
    const {
      delay = 0
    } = this
    ...
    observe((e) => { isEnterBtn(e) && isSpecialPressed() && this.__insertLinebreak() }, keydown$)
  ...
  __onKeyPress (e) { // eslint-disable-line class-methods-use-this
    // eslint-disable-next-line no-unused-expressions
  ...
  __processMessage (value) { // eslint-disable-line class-methods-use-this
...
export const InputElement = withStyle(html)(
  _InputElement,
  buttonStyle,
  inputStyle,
  textareaStyle
